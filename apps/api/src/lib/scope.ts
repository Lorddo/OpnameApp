...
export async function applyInspectionListScope<T extends { eq: Function; in: Function }>(
  query: T,
  db: SupabaseClient,
  auth: AuthContext,
...
export function applyPhotoOwnerScope<T extends { eq: Function }>(query: T, auth: AuthContext): T {
